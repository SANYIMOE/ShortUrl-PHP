                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="min-height:10%; max-height:350px; overflow-y:scroll; overflow-x:none; position:relative;">
                            ...
                            <div style="margin-left:25px;">
                                ...
                                <h5>输出 关于<strong><?php echo $info['URL'] . '/{alias}'; ?></strong> 的所有网址 </h5>	
                            </div>
                            <br>
                            ...
                            <br>
                            <h5><strong>基础短链接</strong> </h5>
                            <div style="margin-left:25px;">
                                <h5>输入 <strong><?php echo $info['URL'] . '/api2.php?url=XXX'; ?> </h5>								
                                <h5><strong>XXX</strong> 是你的 <strong>目标网址 </strong>，请输入一个有效的网址, 使用 <strong>http:// 或 https:// 开头</h5>								
                                <h5>只输出 <strong><?php echo $info['URL'] . '/{alias}'; ?></strong> 的短网址</h5>
                                <h5>除短链接外，此项不支持任何功能，若非特殊程序，不建议使用。</h5>
                            </div>
                        </div>
                    </div>
